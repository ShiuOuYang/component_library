                ...
                >
                  <div class="flex items-center">
                    <span
                      ...
                      :class="[headerFontSizeClass, column.defaultFixed ? 'text-blue-600 font-semibold' : 'text-gray-700']"
                    >
                      {{ column.title }}
                    </span>
                  </div>
                  ...
                  >
                    ...
                    >
                      <ChptIcon weight="500" color="gray-500" size="10">keep</ChptIcon>
                    </div>
                    <div
                      v-else
                      class="absolute cursor-pointer hover:bg-gray-300/30 bg-white rounded-md border flex justify-center items-center right-0 top-0 w-3 h-3 z-50"
                    ...
                    >
                      <ChptIcon weight="500" color="gray-500" size="10">keep_off</ChptIcon>
                    </div>
                  </div>
                  ...
                  <template v-if="props.isFilter && !hasActiveFilter(column.dataIndex)">
                    ...
                    >
                      <ChptIcon weight="500" color="gray-500" size="12">arrow_drop_down</ChptIcon>
                    </div>
                  </template>
                  <template v-if="props.isFilter && hasActiveFilter(column.dataIndex)">
                    <div
                      ...
                      @click="clickHandler($event, column)"
                    >
                      <ChptIcon weight="300" color="gray-500" size="12">filter_alt</ChptIcon>
                    </div>
                  </template>
                </div>
              </th>
      ...
      <template #default>
        <div class="p-0 text-sm text-gray-700 min-w-[200px]">
          <div class="flex items-center justify-end gap-1 mb-1.5">
            ...
            >
              <ChptIcon weight="500" size="20" color="gray-400">done_all</ChptIcon>
            </button>
            <button
              type="button"
              title="關閉"
            ...
            >
              <ChptIcon weight="500" size="20" color="gray-400">close</ChptIcon>
            </button>
          </div>
