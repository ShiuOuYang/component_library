<template>
  ...
  >
    <span
      ...
      :class="[trackSizeClass, props.modelValue ? onColorClass : 'bg-gray-300']"
      @click="toggle"
    >
      <input
        type="checkbox"
    ...
    <span
      ...
      :class="props.disabled ? 'text-gray-400' : 'text-gray-700'"
    >
      {{ props.label }}
    </span>
  </label>
...
import type { ColorVariant } from './types/ui.types'
