 ...
 *
 * 此檔原名 CommonTooltip 並被列在 legacy 區，但它既非 ChptTooltip 的舊版，
 * 也不是重複實作 —— ChptFixedTable 正在使用它，設計令牌也把它當成正式的
 * z-index 層級（--z-tooltip）。因此改名為 Chpt* 並移出 legacy 分類。
 */
