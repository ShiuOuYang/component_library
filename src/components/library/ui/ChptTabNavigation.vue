<template>
  <div class="relative inline-block">
    <!-- 標籤頁導航 -->
    <div class="flex items-center p-1.5 bg-neutral-100/80 backdrop-blur-sm rounded-xl border border-neutral-200/50 shadow-inner">
      <router-link
        ...
        :class="[
          props.fontSize,
          isActive(tab.path)
            ? 'bg-white text-neutral-800 shadow-[0_2px_10px_-2px_rgba(0,0,0,0.1)] ring-1 ring-black/5 transform scale-[1.02]'
