...
const colors = {
  /**
   * 主色調 — 品牌綠
   * 🔧 注意：品牌主色是 600（#006644）而非慣例的 500。
   *    400→500→600 之間的明度落差偏大，色階不是平滑漸變，
   *    做連續色階（sequential scale）時建議走 viz.sequential 而非直接串接 50~900。
   */
  primary: {
    DEFAULT: '#006644', // = 600，讓 bg-primary / text-primary 可直接使用
    50: '#E8F5EF',
    100: '#CCE8D9',
    200: '#99D1B8',
    300: '#66B997',
  ...
  semantic: {
    ...
    danger: '#DC2626',
    info: '#0284C7',
    // 🔧 補上 hover 態，原本 .btn-danger:hover 是硬寫 #b91c1c
    successHover: '#15803D',
    warningHover: '#A16207',
    dangerHover: '#B91C1C',
    infoHover: '#0369A1',
...
const shadows = {
  ...
  primary: '0 4px 14px 0 rgba(0, 102, 68, 0.25)',
  'primary-lg': '0 10px 25px 0 rgba(0, 102, 68, 0.2)',
